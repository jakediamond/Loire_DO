...
saveRDS(mm_all, "F:/DataLocalePerso/Jake/metab_veryconstrainedK_gppconstrained_all_discharge_bins_obs_deficit")
# Inspect the model -------------------------------------------------------
mm <- mm_all %>%
...
saveRDS(mm_save, "Data/Loire_DO/metab_veryconstrainedK_gppconstrained_all_discharge_bins_obs_deficit")
...
process_error_file <- mm_all %>%
  ...
  left_join(mm_all %>%
              ...
              select(preds) %>%
              unnest(cols = c(preds)))
saveRDS(process_error_file, "Data/Loire_DO/metab_veryconstrainedK_gppconstrained_all_discharge_bins_obs_deficit_process_errors")